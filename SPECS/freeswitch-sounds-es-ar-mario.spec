...
%define SOUNDS_SUFF es/AR/mario
%define SOUNDS_SUFF_LC es/ar/mario
%define SOUND_CATEGORIES ascii digits misc time voicemail

Name:		freeswitch-sounds-es-ar-mario
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds es-AR Mario
...
%description
This package contains es-AR Mario sounds for FreeSWITCH.
