...
%define SOUNDS_SUFF sv/SE/jakob
%define SOUNDS_SUFF_LC sv/SE/jakob
%define SOUND_CATEGORIES ascii currency digits phonetic-ascii time voicemail

Name:		freeswitch-sounds-sv-se-jakob
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds sv-SE Jakob
...
%description
This package contains sv-SE Jakob sounds for FreeSWITCH.
