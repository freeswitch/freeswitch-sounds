...
%define SOUNDS_SUFF fr/CA/june
%define SOUNDS_SUFF_LC fr/ca/june
%define SOUND_CATEGORIES ascii conference currency digits directory extra-attempt-record ivr misc phonetic-ascii time voicemail

Name:		freeswitch-sounds-fr-ca-june
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds fr-CA June
...
%description
This package contains fr-CA June sounds for FreeSWITCH.
