...
%define SOUNDS_SUFF zh/CN/sinmei
%define SOUNDS_SUFF_LC zh/cn/sinmei
%define SOUND_CATEGORIES digits time

Name:		freeswitch-sounds-zh-cn-sinmei
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds zh-CN Sinmei
...
%description
This package contains zh-CN Sinmei sounds for FreeSWITCH.
