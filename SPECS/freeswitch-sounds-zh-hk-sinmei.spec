...
%define SOUNDS_SUFF zh/HK/sinmei
%define SOUNDS_SUFF_LC zh/hk/sinmei
%define SOUND_CATEGORIES digits time

Name:   freeswitch-sounds-zh-hk-sinmei
Version:  20180515
Release:  1%{?dist}
Summary:  FreeSWITCH Sounds zh-HK Sinmei
...
%description
This package contains zh-HK Sinmei sounds for FreeSWITCH.
