...
%define SOUNDS_SUFF en/US/callie
%define SOUNDS_SUFF_LC en/us/callie
%define SOUND_CATEGORIES ascii base256 conference currency digits directory ivr misc phonetic-ascii time voicemail zrtp

Name:		freeswitch-sounds-en-us-callie
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds en-US Callie
...
%description
This package contains en-US Callie sounds for FreeSWITCH.
