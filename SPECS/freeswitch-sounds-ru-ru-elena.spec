...
%define SOUNDS_SUFF ru/RU/elena
%define SOUNDS_SUFF_LC ru/ru/elena
%define SOUND_CATEGORIES ascii conference currency digits directory ivr misc phonetic-ascii time users voicemail zrtp

Name:		freeswitch-sounds-ru-ru-elena
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds ru-RU Elena
...
%description
This package contains ru-RU Elena sounds for FreeSWITCH.
