...
%define SOUNDS_SUFF en/CA/june
%define SOUNDS_SUFF_LC en/ca/june
%define SOUND_CATEGORIES ascii conference currency digits directory ivr misc phonetic-ascii time voicemail

Name:		freeswitch-sounds-en-ca-june
Version:	20180515
Release:	1%{?dist}
Summary:	FreeSWITCH Sounds en-CA June
...
%description
This package contains en-CA June sounds for FreeSWITCH.
