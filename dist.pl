...
my @languages = qw(en/us/callie en/us/allison en/ca/june fr/ca/june pt/BR/karina ru/RU/elena sv/se/jakob zh/cn/sinmei zh/hk/sinmei music);
my @versions  = qw(1.0.52       1.0.1         1.0.51     1.0.51     1.0.51       1.0.51      1.0.50      1.0.51       1.0.51       1.0.52);
